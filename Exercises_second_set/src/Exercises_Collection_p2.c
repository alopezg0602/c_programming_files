...
#define FUNCTION_LIST\
	...
	FUNCTION_MEM(functionCode_1, "\n1.Ejercicio 1: Copiar string")\
	FUNCTION_MEM(functionCode_2, "\n2.Ejercicio 2: Contar caracteres")\
	FUNCTION_MEM(functionCode_3, "\n3.Ejercicio 3: Reservaciones")\
	FUNCTION_MEM(functionCode_4, "\n4.Ejercicio 4: Longitud de string")\
	FUNCTION_MEM(functionCode_5, "\n5.Ejercicio 5: Comparar strings")\
	FUNCTION_MEM(functionCode_6, "\n6.Ejercicio 6: Biblioteca")\
	FUNCTION_MEM(functionCode_7, "\n7.Ejercicio 7: Registro de alumnos")\
	FUNCTION_MEM(functionCode_8, "\n8.Ejercicio 8: Arreglar codigo")\
...
void cpyarray(int *arr1, int *arr2, int lenght);
